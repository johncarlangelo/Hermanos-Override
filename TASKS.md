...
- [ ] Inspect the existing repository structure and current Electron/React/Vite setup.
- [ ] Identify existing dependencies worth retaining.
- [ ] Identify obsolete UI, mock data, and components that should be removed.
- [ ] Confirm the application currently has a clean baseline build/start command.
- [ ] Document the architectural starting point in `PROGRESS.md`.
